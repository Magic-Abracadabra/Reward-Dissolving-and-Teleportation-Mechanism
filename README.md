...
The *Teleportation Mechanism* is an *algorithm-extension*, which can be applied to many optimization algorithms. By leveraging the monotone bounded convergence theorem, we can let this plugin help the optimization algorithm converges to global optima with probability 1 under certain conditions.
